...
export default function CartPage() {
  ...
  if (cart.length === 0) {
    return (
      <div className="text-center py-16">
        ...
        <Link href="/" className="text-blue-600 font-medium hover:underline">Continue Shopping &rarr;</Link>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <button 
        onClick={() => alert("Redirecting to International Payment Gateway (Stripe/PayPal)...")}
