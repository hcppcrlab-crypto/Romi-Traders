  ...
  return (
    <div>
      <section className="mb-10 text-center py-12 bg-gradient-to-r from-blue-600 to-indigo-700 text-white rounded-2xl shadow-lg">
        <h1 className="text-4xl font-extrabold mb-3">Welcome to Romi Traders</h1>
        <p className="text-lg opacity-90">International Quality Products, Fast Delivery & Secure Checkout</p>
      </section>
